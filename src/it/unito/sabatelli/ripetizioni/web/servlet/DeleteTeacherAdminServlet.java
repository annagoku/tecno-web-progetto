...
@WebServlet(name="DeleteTeacherAdmin", urlPatterns = "/servlets/DeleteTeacherAdmin")
  ...
  public void processRequestPost (HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, IOException {
    ...
    try{
      if(!user.getRole().equalsIgnoreCase("administrator")){
        ...
        Teacher t=gson.fromJson(request.getParameter("teacherToDelete"), Teacher.class);
        if (t!=null){
          int row=dao.deleteTeacherAdmin(t);
